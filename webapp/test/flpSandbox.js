		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hourly Cycle",
									"targetURL": "#comairbuszqmhrcyc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comairbuszqmhrcyc-display": {
								"semanticObject": "comairbuszqmhrcyc",
								"action": "display",
								"description": "QM Hourly Cycle",
								"title": "Hourly Cycle",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.airbus.zqmhrcyc",
									"url": sap.ui.require.toUrl("com/airbus/zqmhrcyc")
								}
							}
						}
					}
